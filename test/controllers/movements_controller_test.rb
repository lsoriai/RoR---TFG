...
class MovementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create movement" do
    assert_difference('Movement.count') do
      post movements_url, params: { movement: { color: @movement.color, cord: @movement.cord, figure: @movement.figure, game_id: @movement.game_id, n_mov: @movement.n_mov } }
    end
  ...
  test "should update movement" do
    patch movement_url(@movement), params: { movement: { color: @movement.color, cord: @movement.cord, figure: @movement.figure, game_id: @movement.game_id, n_mov: @movement.n_mov } }
